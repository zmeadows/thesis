...
For the particular case of heavy resonance searches, many separate models have been developed such as TODO. % cite/explain a few
...
%TODO: reference electroweak section of theory chapter and add some brief explanation
...
%TODO: include mention of Z' and W' labels
%TODO: paragraph explain choice of fully hadronic final state, maybe citing ATLAS/CMS results for other final states, and citing tables/figures about V/H branching ratios below
%TODO: discuss large background yield and corresponding very high bkg rejection of jet-tagging techniques
...
% Feynman Diagrams: https://www-d0.fnal.gov/Run2Physics/top/top_public_web_pages/top_feynman_diagrams.html
...
The MC samples are generated with \MADGRAPH5\_aMC@NLO 2.2.2 \cite{Alwall:2014hca} interfaced to \PYTHIA8.186 \cite{Sjostrand:2007gs} for shower and hadronization, with the NNPDF23 PDF set \cite{Ball:2011mu} and the ATLAS A14 tune \cite{ATL-PHYS-PUB-2014-021}. Tables \ref{tab:hvta_wh} and \ref{tab:hvta_zh} show the cross-sections and sample information for the HVT Model A samples, generated at different mass points in the range of 1 to 5 TeV.
...
The \tt samples are generated with \textsc{Powheg-Box} v2 \cite{Frixione:2002ik} with the NNPDF30 PDF, interfaced with \PYTHIA 8 with NNPDF23 PDF and \textsc{A 14} tune for parton shower.
...
%TODO: reference trigger section
%TODO: explain pre-scaling in trigger section
...
%TODO: fix references/descriptions
\begin{table}[htbp!]
\normalsize
\centering
\begin{tabular}{c|c}
...
%The pre/post kinematic re-weighting distributions and their comparison to data are shown in Appendix~\ref{app:bdt_valid} for the other BDT training variables.
...
%TODO: use VR2B plots from paper, as well as other track jet variables from paper aux. material
\begin{figure}[htbp!]
\begin{center}
...
\subsection{Overview}
%TODO: cite hypothesis testing by gregory schott from 'data analysis in high energy physics' textbook
%TODO: not just production cross section, but HVT model parameters
%TODO: just replace this section with limited description as seen in ATLAS papers and other theses
